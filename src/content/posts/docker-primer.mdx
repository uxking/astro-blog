...
description: Just a cheat sheet for using Docker. Includes some basic commands after you get Docker installed and running.
image: ./images/docker-primer.png
alt: Image of a ship with containers
---
...
`CONTAINER ID` can be viewed by using the `docker ps -a` command
